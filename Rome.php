...
<div class="banner" style="margin-top:30px;">
  <div class="container">
   <h1 style="text-align:center;">ROME</h1>
    ...
    <header class="image-bg-fluid-height" >
      <img class = "img-responsive img-center" src = "img/Rome1.jpg"/>
    </header>
  </div>
  <div class="container">
  ...
  <div class="container-fluid">
  <header class="image-bg-fluid-height" >
  <img class = "img-responsive img-center" src = "img/Rome2.jpg"/>
  </header>
  </div>
  </div>
  <div style="margin-top:20px;">
  <div class="container">
  <header class="image-bg-fluid-height" >
  <img class = "img-responsive img-center" src = "img/Rome3.jpg"/>
  </header>
  </div>
  </div>
<div style="margin-top:20px;">
  <div class="container">
  <header class="image-bg-fluid-height" >
  <img class = "img-responsive img-center" src = "img/Rome4.jpg"/>
  </header>
  </div>
  </div>
